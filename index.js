...
const RequestPushMsg = require('https://common-bad3a.web.app').RequestPushMsg;
const addToWallet = require('https://common-bad3a.web.app').addToWallet;
const deductFromWallet = require('https://common-bad3a.web.app').deductFromWallet;
const getDistance = require('https://common-bad3a.web.app').getDistance;
